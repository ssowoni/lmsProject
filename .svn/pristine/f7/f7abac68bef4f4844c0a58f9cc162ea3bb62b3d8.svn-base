...
public class ComnCodController {
	...
	@ResponseBody
	public Map<String, Object> listComnGrpCodvue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
	...
	public Map<String, Object> selectComnGrpCod (Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
		...
		//{"result":"SUCCESS","comnGrpCodModel":{"row_num":0,"grp_cod":"xxxxx","grp_cod_nm":"xxxxx","grp_cod_eplti":null,"tmp_fld_01":"0","tmp_fld_02":null,"tmp_fld_03":null,"use_poa":"Y","fst_enlm_dtt":1638494700000,"reg_date":null,"fst_rgst_sst_id":"admin","fnl_mdfd_dtt":"2021-12-03 10:25:00.0","fnl_mdfr_sst_id":"admin","detailcnt":0},"resultMsg":"조회 되었습니다."}
	...
	public Map<String, Object> listComnDtlCodvue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
		...
		// 공통 상세코드 목록 조회
		List<ComnDtlCodModel> listComnDtlCodModel = comnCodService.listComnDtlCod(paramMap);
		resultMap.put("listComnDtlCodModel", listComnDtlCodModel);
		
		// 공통 상세코드 목록 카운트 조회
		int totalCount = comnCodService.countListComnDtlCod(paramMap);
		resultMap.put("totalCntComnDtlCod", totalCount);
		
		resultMap.put("pageSize", pageSize);
		resultMap.put("currentPageComnDtlCod",currentPage);
