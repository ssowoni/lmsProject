...
public class SampleComnCodController {
    ...
    * 그룹코드 목록조회
    */
   @RequestMapping("gouppcodelistvue.do")
   @ResponseBody
   public Map<String,Object> gouppcodelistvue(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
      ...
      returnmap.put("groupcodelist", groupcodelist); 
      returnmap.put("groupcodecount", groupcodecount);
      returnmap.put("groupcodecurrentPage", groupcodelist); 
