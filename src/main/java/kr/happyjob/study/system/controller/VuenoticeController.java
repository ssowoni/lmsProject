...
public class VuenoticeController {
	...
	@RequestMapping("swVueBoard.do")
	public String swVueBoard(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
