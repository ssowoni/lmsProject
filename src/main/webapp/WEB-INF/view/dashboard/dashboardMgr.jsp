...
<script type="text/javascript">
		...
		function init() {
			Vue.component('my-component',{
                template : '<div>전역 컴포넌트<br><select>  <option> 샘플 </option>  <option> 샘플2 </option> </select></div>'
            });
			...
			vuevar = new Vue({
				  ...
				  methods:{					
					  ...
					  flagchange:function() {
						  if(this.disflag) {
							  this.disflag =false;
							  this.inhtml = "<h3>2222222222222222222222</h3>";
						  
						  } else {
							  this.disflag =true;
							  this.inhtml = "<h3>3333333333333333333333</h3><select><option>111111111 </option> <option>2222222 </option>   </select>";
						  }
	...
	function fListInfResult(data, currentPage) {
		...
		grouplist.pagenavi = paginationHtml;
					...
					<div class="content" style="margin-bottom:20px;">
                        ...
                        <div id="vuevar">
								...
								<div class="fixed-table-body">		
										...
										<input type="text"  id="a11111"  v-if="disflag"  v-model="inputnum"  />
										     
										     <input type="text" id="a2222"  v-else  v-model="inputtext" />
										     
										     <input type="text" id="a3333"  v-show="disflag"  v-model="inputtext" />  
										     
										     <div @click="flagchange()">눌러봐</div>
							...
							<div id="vuecheck">
									...
									<br>
									<!-- v-bind:id="item.vueid :id로 표현해도 된다. -->
					        ...
					        <div id = "vueprop2">
					            ...
					            <my-component-child msg = "황기현"></my-component-child>
					        </div>
					        <br>
							<div id="vueprop">
							        <p class="conTitle" style="margin-bottom: 1%;">
		                    ...
		                    <table width="100%" class="col" border=0>
					        	...
					        	<div id="divComGrpCodList">
									<table class="col">
										...
										<tbody v-for=" (item,index) in listitem" v-if="listitem.length">
